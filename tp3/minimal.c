...
void drawFirstArm(int full){
	/* drawLine(float x1, float x2, float x2, float y2, int r, int g, int b){ */
	glPushMatrix();
		glRotatef(alpha,0.0,0.0,1.0);
		glPushMatrix();
			glScalef(2.0,2.0,1.0);
			drawCircle(full,255,0,0);
		glPopMatrix();
		glPushMatrix();
